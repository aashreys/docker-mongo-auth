...
# Reflections Database User
create_user ${MONGODB_REFLECTIONS_DATABASE:-"reflections"} ${MONGODB_REFLECTIONS_USER:-"reflectionsAppUser"} ${MONGODB_REFLECTIONS_PASS:-"reflectionsPass"}

# Mvp Database User
create_user ${MONGODB_MVP_DATABASE:-"mvp"} ${MONGODB_MVP_USER:-"mvpAppUser"} ${MONGODB_MVP_PASS:-"mvpPass"}
